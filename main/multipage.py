...
about_page = st.Page(
    page=r"C:\Users\Omolayo-Akinola\Documents\Neural networks\learning\stream\learn\main\pages\Home.py",
    title="home",
    icon="👤",
...
project_page = st.Page(
    page=r"C:\Users\Omolayo-Akinola\Documents\Neural networks\learning\stream\learn\main\pages\BeadPatternGeneraton.py",
...
st.logo(
    r"C:\Users\Omolayo-Akinola\Documents\Neural networks\learning\stream\learn\main\logo\ChatGPT Image Apr 11, 2025, 03_18_52 AM.png",
